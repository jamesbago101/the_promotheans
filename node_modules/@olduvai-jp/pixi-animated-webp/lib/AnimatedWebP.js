...
const _AnimatedWebP = class extends pixi_js.Sprite {
  constructor(frames, options) {
    super(pixi_js.Texture.EMPTY);
    ...
    this.texture = pixi_js.Texture.from(canvas);
  ...
  static async fromBuffer(buffer, options) {
    ...
    const frames = [];
    const canvas = pixi_js.DOMAdapter.get().createCanvas();
    const context = canvas.getContext("2d", { willReadFrequently: true });
    let totalDuration = 0;
  ...
  play() {
    ...
    this._playing = true;
    if (this._autoUpdate && !this._isConnectedToTicker) {
      pixi_js.Ticker.shared.add(this.update, this, pixi_js.UPDATE_PRIORITY.HIGH);
...
//# sourceMappingURL=AnimatedWebP.js.map
